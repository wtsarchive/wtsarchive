...
// Setting page title
var setPageTitle = function(text, secondaryText) {
...
Router.route('/', {
    ...
    subscriptions: function() {
      return Meteor.subscribe('items-recent', Session.get("language"));
    },
...
Router.route('/pubs/:slug', {
    ...
    subscriptions: function() {
      ...
      return Meteor.subscribe('items-category', category._id, {
        ...
        perPage: this.params.query.perPage || ClientConfig.defaultPerPage
      });
    },
    onAfterAction: function() {
      var category = Categories.findOne({slug: this.params.slug});
      setPageTitle('Publications', category.name);
    }
});
...
Router.route('/pub/:slug', {
    ...
    onAfterAction: function() {
      ...
      setPageTitle('Publications', item.title);
    }
});
...
Router.route('/letters/:slug', {
    ...
    onAfterAction: function() {
      var category = Categories.findOne({slug: this.params.slug});
      setPageTitle('Letters', category.name);
    }
});
...
Router.route('/letter/:slug', {
    ...
    onAfterAction: function() {
      var item = Items.findOne({slug: this.params.slug});
      setPageTitle('Letters', item.title);
    }
});
...
Router.route('/tag/:tag', {
    ...
    subscriptions: function() {
      return Meteor.subscribe('items-tag', this.params.tag, {
        lang: Session.get("language"),
        page: this.params.query.page,
        perPage: this.params.query.page || ClientConfig.defaultPerPage
      });
    },
    onAfterAction: function() {
      setPageTitle(s.capitalize(this.params.tag));
    }
});
